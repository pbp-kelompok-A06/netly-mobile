...
// Jika class BookingListPage ada, pastikan diimport di sini. 
// Saya menggunakan BookingListScreen yang sudah diimport di atas sebagai target pengganti.
...
class _BookingDetailAdminScreenState extends State<BookingDetailAdminScreen> {
  ...
  void didChangeDependencies() {
    ...
    // HINDARI Ancestor Lookup Error: Dapatkan Provider di sini (didChangeDependencies), 
    // bukan di dispose() atau setelah await.
  ...
  @override
  void dispose() {
    // Jika Anda memiliki StreamSubscription, TextEditingController, atau Timer 
    // yang bergantung pada data yang diambil dari Provider di didChangeDependencies(),
    // Anda akan membatalkannya di sini MENGGUNAKAN referensi yang sudah tersimpan (_service atau lainnya), 
    // BUKAN menggunakan 'context' untuk lookup Provider lagi.
 ...
 void _fetchBookingDetail() {
  setState(() {
   // Tidak perlu mengirim _service.request lagi jika sudah ada di _service. 
   // Namun, saya biarkan sesuai aslinya jika BookingService.fetchBookingDetail memerlukannya.
   ...
   Future.microtask(() {
    if (mounted) {
     // Pop detail screen
          ...
          // Gantikan list screen dengan versi yang sudah diperbarui
          Navigator.pop(
      context,
      MaterialPageRoute(builder: (context) {
       // Menggunakan BookingListScreen yang sudah diimport
