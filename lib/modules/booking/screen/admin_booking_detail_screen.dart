                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Divider(),
                              _buildDetailRow(context, Icons.sports_soccer, 'Lapangan', booking.lapangan.name),
                              _buildDetailRow(
                                context,
                                Icons.date_range,
                                'Dibuat Pada',
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildDetailRow(context, Icons.person, 'Nama Lengkap', booking.userFullname),
                              _buildDetailRow(context, Icons.perm_identity, 'User ID', booking.userId,
                      ...
                      const SizedBox(height: 30),
                      Text('Aksi Admin:', style: Theme.of(context).textTheme.titleMedium),
                      const SizedBox(height: 10),
                      ElevatedButton.icon(
