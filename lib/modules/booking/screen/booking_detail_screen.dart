          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                icon: const Icon(Icons.check_circle_outline, color: Color(0xFFD7FC64)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Detail Booking
          _buildInfoRow(Icons.person_outline, 'Player', booking.userFullname), // Perubahan di sini
          _buildInfoRow(Icons.location_on_outlined, 'Lokasi', booking.lapangan.location ?? 'N/A'),
          _buildInfoRow(Icons.date_range, 'Dibuat', DateFormat('d MMM y, HH:mm').format(booking.createdAt)),
          ...
          const Text(
            'Jadwal Dipilih:', 
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xFF243153)),
          ),
          ...
          Row(
            ...
            children: [
              const Text('TOTAL HARGA', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF243153))),
              Text(
                formatter.format(booking.totalPrice), 
                style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFFD7FC64), backgroundColor: Color(0xFF243153)),
              ),
            ],
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(value, style: const TextStyle(fontSize: 16, color: Color(0xFF243153), fontWeight: FontWeight.w600)),
              ],
            ),
          ),
        ],
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: const TextStyle(fontWeight: FontWeight.w500, color: Color(0xFF243153)),
            ),
          ),
        ],
      ),
      ...
      body: FutureBuilder<Booking>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('Gagal memuat detail booking: ${snapshot.error}', textAlign: TextAlign.center));
